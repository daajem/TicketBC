...
const ListaReporteDiario = (props) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Button onPress={()=>props.navigation.navigate('GuardarReporteDiario')} title="Registrar Reporte"/>

      <View style={styles.listaContainer}>
        {lista.map((list) => (
        <TouchableOpacity key={list.id} onPress={()=> props.navigation.navigate('ShowReporteDiario', {fechaID:list.id})}> 
